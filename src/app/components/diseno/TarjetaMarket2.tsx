/* =====================================================
   Componente de Diseño: Tarjeta de artículo 2 de Market (expandida)
...
const exampleProduct = {
  ...
  p: '$472',
  o: '$590',
  desc: 'Silicona líquida premium, compatible con carga inalámbrica. Protección para bordes y cámara. Disponible en 8 colores.',
  r: 4.3,
  rv: 89,
  publishedDate: '20/01/2025',
};

export function TarjetaMarket2() {
  return (
    <div className="oddy-card-slot" style={{ width: '200px', height: '300px' }}>
      <div className="oddy-fc flipped">
            ...
            <div className="oddy-fb-content">
              ...
              <div className="oddy-panel-miniatures" style={{ display: 'flex', gap: '8px', marginBottom: '12px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
                {[exampleProduct.img, null, null, null, null].map((img, idx) => (
                  <div key={idx} style={{ width: '70px', height: '70px', borderRadius: '8px', overflow: 'hidden', border: idx === 0 ? '2px solid #FF6835' : '1.5px solid rgba(255,255,255,0.3)', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: img ? 1 : 0.3, backgroundColor: img ? 'transparent' : 'rgba(255,255,255,0.1)' }}>
              ...
              <div style={{ display: 'flex', gap: '4px', marginTop: '5px', width: '100%' }}>
                ...
                <button className="oddy-fb-add" style={{ background: '#FF6835', flex: 2 }}>
